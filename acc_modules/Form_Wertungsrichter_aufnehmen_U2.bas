...
Private Sub km_holen_Click()
    ...
    If wr.RecordCount > 0 Then
        ...
        objIE.Run """https://www.google.de/maps/dir/" & wr!Straße & ", " & wr!PLZ & " " & wr!Ort & "/" & re!Veranst_Ort & Chr(13) & Chr(10) & """"  '"About:blank"
    End If
End Sub

Private Sub Kontrollkästchen31_Click()
    DoCmd.Requery
End Sub
...
Private Sub Kontrollkästchen31_KeyDown(KeyCode As Integer, Shift As Integer)
    Pfeil_up_down KeyCode, Shift
End Sub
